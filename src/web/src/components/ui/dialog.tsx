...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("qds-dialog-header flex flex-col gap-2", className)}
      {...props}
    />
  )
}
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "qds-dialog-footer -mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t p-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
