...
async def get_current_settings(
    ...
    return {
        ...
        "redis": {"url": "****"},
        "binance": {
            "api_key": _mask_key(settings.binance.api_key.get_secret_value()) if settings.binance.api_key.get_secret_value() else "",
            "api_secret": _mask_key(settings.binance.api_secret.get_secret_value()) if settings.binance.api_secret.get_secret_value() else "",
