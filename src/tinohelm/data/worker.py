...
# Strong references to background tasks so the event loop cannot GC them
# before they complete. Each task removes itself via a done-callback.
    ...
    while True:
        ...
        if not advanced:
            ...
            if settings.data.job_concurrency == 1:
                ...
                t = asyncio.create_task(_schedule_delayed_wake(redis_url))
